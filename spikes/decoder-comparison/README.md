...
Categories include normal screen content, plain text, multiple, rotated, inverted, low-contrast, blurred, damaged, perspective-like distortion, small-in-high-resolution, Unicode, binary, unusual and malformed URLs, and false-positive backgrounds. Generated corpus files are under `fixtures/generated/`.
